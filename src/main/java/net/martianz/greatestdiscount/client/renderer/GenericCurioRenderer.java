...
public class GenericCurioRenderer implements CurioRenderer {

    private final ResourceLocation texture;
    private final HumanoidModel<LivingEntity> model;

    public GenericCurioRenderer(String name, HumanoidModel<LivingEntity> model) {
        this(CurioRenderer.getTexturePath(name), model);
    }

    public GenericCurioRenderer(ResourceLocation texture, HumanoidModel<LivingEntity> model) {
    ...
    public void render(ItemStack stack, LivingEntity entity, int slotIndex, PoseStack poseStack, MultiBufferSource multiBufferSource, int light, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        CurioRenderer.followBodyRotations(entity, model);
