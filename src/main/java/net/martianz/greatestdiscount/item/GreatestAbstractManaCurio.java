package net.martianz.greatestdiscount.item;

//redoing the item class from ars is mandatory due to stupid programming or lack of my skill lol
...
public abstract class GreatestAbstractManaCurio extends ArsNouveauCurio {

    public GreatestAbstractManaCurio(Properties properties) {
        super(properties);
    }
